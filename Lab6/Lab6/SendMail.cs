...
namespace lab5_5
{
    public partial class SendMail : Form
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            message.Subject = "NT106";
            message.Body = new TextPart("html")
            {
                Text = $"<div><p id=\"monAn\" style = \"font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size:40px;text-align: center\" ><b> {monAn}</b></p><p id=\"Gia\" style = \"font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size:30px;text-align: center\" >{Gia}</p><p id=\"diaChi\" style = \"font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size:30px;text-align: center\" >{diaChi}</p></div><p style= \"text-align: center; \"><img src = \"{hinhAnh}\"  style = \"border-radius: 10%\" width = \"500\" height = \"360\"></p>"
