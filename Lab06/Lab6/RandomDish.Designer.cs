namespace lab5_5
{
    partial class RandomDish
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnMail
            // 
            btnMail.BackColor = Color.FromArgb(255, 224, 192);
            btnMail.Font = new Font("Cambria", 10.2F, FontStyle.Bold, GraphicsUnit.Point);
            btnMail.ForeColor = Color.FromArgb(128, 64, 0);
            btnMail.Location = new Point(899, 77);
            btnMail.Name = "btnMail";
            btnMail.Size = new Size(141, 36);
            btnMail.TabIndex = 4;
            btnMail.Text = "Mời bạn bè...";
